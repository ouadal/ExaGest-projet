...
public class Moyenne implements Serializable {
    ...
    public Moyenne(Long id, double moyenneTotale, String mention, Inscription inscription, Examen examen, Session session, LocalDate updateDate, LocalDate addDate) {
        this.id = id;
